...
public class MoviesArray {
    public static Movie[] findAll() {
        return new Movie[]{
            ...
            new Movie("2001: A Space Odyssey", "sci-fi"),
            new Movie("The Maltese Falcon", "drama"),
            new Movie("Raging Bull", "drama"),
            new Movie("E.T. The extra-terrestrial", "sci-fi"),
            ...
            new Movie("A Clockwork Orange", "sci-fi"),
            ...
            new Movie("Close Encounters Of The Third Kind", "sci-fi"),
